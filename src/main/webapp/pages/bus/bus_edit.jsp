...
<body>
	<div class="layui-tab page-content-wrap">
		<form class="layui-form" style="width: 90%; padding-top: 20px;"
			action="${pageContext.request.contextPath }/bus/update" method="post">
				...
				<div class="layui-input-block">
					<div class="layui-col-sm3">
						<input type="text" name="busname" autocomplete="off"
							...
							placeholder="请输入公交线路名称" value="${businfo.busname }"> <input
							type="hidden" name="id" autocomplete="off" lay-verify="required"
							class="layui-input" placeholder="请输入公交线路名称"
							value="${businfo.id }">
					</div>
					<div class="layui-col-sm3">
					...
					<div class="layui-col-sm12">
						<div class="layui-col-sm6">
							<input type="text" name="spot" autocomplete="off"
								lay-verify="required" class="layui-input" value="${spot }"
